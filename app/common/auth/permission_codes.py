...
class PermissionCode(StrEnum):
    ...
    MARKET_INDEX_READ = "MARKET_INDEX_READ"
    MARKET_INDEX_CREATE = "MARKET_INDEX_CREATE"
    ...
    COMPANY_SHAREHOLDER_READ = "COMPANY_SHAREHOLDER_READ"
    COMPANY_SHAREHOLDER_UPDATE = "COMPANY_SHAREHOLDER_UPDATE"

    COMPANY_OFFICER_READ = "COMPANY_OFFICER_READ"
    COMPANY_OFFICER_UPDATE = "COMPANY_OFFICER_UPDATE"

    COMPANY_AFFILIATION_READ = "COMPANY_AFFILIATION_READ"
    COMPANY_AFFILIATION_UPDATE = "COMPANY_AFFILIATION_UPDATE"
    ...
    STOCK_PRICE_HISTORY_READ = "STOCK_PRICE_HISTORY_READ"
    STOCK_PRICE_HISTORY_UPDATE = "STOCK_PRICE_HISTORY_UPDATE"

    STOCK_INTRADAY_READ = "STOCK_INTRADAY_READ"
    STOCK_INTRADAY_UPDATE = "STOCK_INTRADAY_UPDATE"
